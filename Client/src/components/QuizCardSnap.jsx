...
const QuizCardSnap = (props) => {
    return (
        <div className="w-60 cursor-pointer  h-52 rounded-md overflow-hidden  shadow-md hover:shadow-lg transition ease-out  hover:bg-blue-50 bg-white">
            ...
            <div className=" flex h-full w-full items-center justify-center flex-col space-y-3">
                ...
                <h1 className="text-xl font-bold text-center text-gray-800">Computer Programming</h1>
